...
export default function Cover() {
  return (
    <main className="flex-1 flex flex-col items-center px-6 py-16 text-center">
      ...
      <h1 className="rise rise-1 hand text-ink text-6xl sm:text-8xl leading-[0.95]">bloom for you</h1>
      ...
      <p className="rise rise-2 hand text-sage-deep text-2xl mt-3 mb-10">good things take time ♡</p>
